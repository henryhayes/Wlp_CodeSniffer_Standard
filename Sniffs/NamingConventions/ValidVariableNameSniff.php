 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class WLP_Sniffs_NamingConventions_ValidVariableNameSniff extends PHP_CodeSniffer_Standards_AbstractVariableSniff
{
    ...
    protected function processMemberVar(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if ($isPublic === false && $memberName{0} !== '_') {
            $error = ucfirst($scope) .' member variable "%s" must be prefixed with an underscore';
