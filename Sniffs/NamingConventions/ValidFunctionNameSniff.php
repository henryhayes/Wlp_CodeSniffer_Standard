 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class WLP_Sniffs_NamingConventions_ValidFunctionNameSniff extends PHP_CodeSniffer_Standards_AbstractScopeSniff
{
    ...
    protected function processTokenWithinScope(PHP_CodeSniffer_File $phpcsFile, $stackPtr, $currScope)
    {
        ...
        if ($isPublic === false && $methodName{0} !== '_') {
            $error = ucfirst($scope) .' method name "%s" must be prefixed with an underscore';
