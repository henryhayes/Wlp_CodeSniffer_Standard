...
class WLP_Sniffs_Commenting_FileCommentSniff implements PHP_CodeSniffer_Sniff
{
    ...
    {
        $docBlock    = (get_class($this) === 'WLP_Sniffs_Commenting_FileCommentSniff') ? 'file' : 'class';
