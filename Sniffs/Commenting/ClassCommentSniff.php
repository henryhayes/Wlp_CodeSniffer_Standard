...
if (class_exists('WLP_Sniffs_Commenting_FileCommentSniff', true) === false) {
    $error = 'Class WLP_Sniffs_Commenting_FileCommentSniff not found';
    throw new PHP_CodeSniffer_Exception($error);
}
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class WLP_Sniffs_Commenting_ClassCommentSniff extends WLP_Sniffs_Commenting_FileCommentSniff
{
